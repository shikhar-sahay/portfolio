...
- **Pieces of Me:** a theme-following chapter (paper in light, warm charcoal in dark) holding the fragment instrument (no default selection; Literature opens an editorial archive stage and Music opens a live listening stage below the selectors), the mosaic statement, and the full-bleed notes wall.
