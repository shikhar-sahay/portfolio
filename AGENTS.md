...
- **Pieces of Me:** a theme-following chapter (paper in light, warm charcoal in dark) holding the fragment instrument (no default selection; Literature, Music, and Football open their own stages below the selectors), the mosaic statement, and the full-bleed notes wall.
