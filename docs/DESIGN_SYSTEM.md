...
- Hero scene `h-[120svh]` with `h-dvh` sticky; statements use `h-[120svh] sm:h-[200svh]` pulled up `-mt-[100dvh]` so the compact mobile handoff is short while desktop keeps the longer composition
